...
const LOADING_TIPS: string[] = [
  ...
  "Torches brighten dark caves; place them to keep mobs out and yourself safer.",
  ...
  "Fall damage hurts—drop carefully from high places.",
  "Mobs can jump over small gaps—use blocks to block their path.",
  "Use stairs to climb up and down slopes fast.",
  ...
  "Craft planks, sticks, and stations early to unlock faster progression.",
  "Shelter before nightfall so mobs don't catch you in the open.",
  "Cooked food restores hunger more reliably than eating raw food.",
  "Keep spare blocks in your hotbar for quick bridges and emergency walls.",
  "Use doors and narrow chokepoints to control melee fights indoors.",
  "Carry torches when mining so you can mark your path back out.",
  "Ore veins often continue behind stone in the background.",
  "Use armor slots to equip gear and reduce incoming damage.",
  "Bows are best used with distance and clear line of sight.",
  "Break grass to plant seeds and grow crops.",
];
